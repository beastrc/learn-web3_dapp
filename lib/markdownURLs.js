...
const markdownUrls = {
  ...
  ceramic: {
    PROJECT_SETUP: `${MARKDOWN_URI}/ceramic/ceramic-01-intro.md`,
    CHAIN_CONNECTION: `${MARKDOWN_URI}/ceramic/ceramic-02-connect.md`,
    LOGIN: `${MARKDOWN_URI}/ceramic/ceramic-03-login.md`,
    BASIC_PROFILE: `${MARKDOWN_URI}/ceramic/ceramic-04-basic-profile.md`,
    CUSTOM_DEFINITION: `${MARKDOWN_URI}/ceramic/ceramic-05-custom-definition.md`,
  },
  the_graph: {
    PROJECT_SETUP: `${MARKDOWN_URI}/the_graph/the-graph-setup.md`,
    GRAPH_NODE: `${MARKDOWN_URI}/the_graph/run-a-graph-node.md`,
    SUBGRAPH_SCAFFOLD: `${MARKDOWN_URI}/the_graph/scaffold-a-subgraph.md`,
    SUBGRAPH_MANIFEST: `${MARKDOWN_URI}/the_graph/hacking-the-manifest.md`,
    SUBGRAPH_SCHEMA: `${MARKDOWN_URI}/the_graph/entity-and-relation.md`,
    SUBGRAPH_MAPPINGS: `${MARKDOWN_URI}/the_graph/define-the-mapping.md`,
    SUBGRAPH_QUERY: `${MARKDOWN_URI}/the_graph/querying-the-subgraph.md`,
  },
};
