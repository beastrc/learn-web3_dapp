...
const markdownUrls = {
  ...
  the_graph: {
    ...
    RUN_A_GRAPH_NODE: `${MARKDOWN_URI}/the_graph/the-graph-02-scaffold-a-subgraph.md`,
    SCAFFOLD_A_SUBGRAPH: `${MARKDOWN_URI}/the_graph/the-graph-02-scaffold-a-subgraph.md`,
    HACKING_THE_MANIFEST: `${MARKDOWN_URI}/the_graph/the-graph-03-hacking-the-manifest.md`,
    QUERY_THE_PUNK: `${MARKDOWN_URI}/the_graph/the-graph-03-hacking-the-manifest.md`,
  },
};
