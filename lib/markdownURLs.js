...
const markdownUrls = {
  ...
  the_graph: {
    ...
    SCAFFOLD: `${MARKDOWN_URI}/the_graph/03-subgraph.md`,
    MANIFEST: `${MARKDOWN_URI}/the_graph/04-manifest.md`,
    ENTITIES: `${MARKDOWN_URI}/the_graph/05-entities.md`,
    MAPPINGS: `${MARKDOWN_URI}/the_graph/06-mappings.md`,
    QUERY: `${MARKDOWN_URI}/the_graph/07-query.md`,
  },
};
