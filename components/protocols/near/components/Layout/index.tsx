...
import type {SidebarI, StepButtonsI, StepI, StepType} from '@near/types';
...
const NextButton = styled(Button)`
  ...
  color: black;
  background: linear-gradient(253deg, #00c1de, #00c08b);
