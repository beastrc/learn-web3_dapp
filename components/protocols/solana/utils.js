...
export const getNodeRpcURL = () => {
  return process.env.NEXT_PUBLIC_USE_DATAHUB === "true"
    ? `https://${process.env.NEXT_PUBLIC_DATAHUB_DEVNET_RPC_URL}/apikey/${process.env.NEXT_PUBLIC_DATAHUB_API_KEY}`
...
export const getNodeWsURL = () => {
  return process.env.NEXT_PUBLIC_USE_DATAHUB === "true"
    ? `wss://${process.env.NEXT_PUBLIC_DATAHUB_DEVNET_WS_URL}/apikey/${process.env.NEXT_PUBLIC_DATAHUB_API_KEY}`
    : process.env.NEXT_PUBLIC_DEVNET_URL;
}
